    ...
    try:
        ...
        if url == "":
            ...
            if choice == 1:
                ...
                subprocess.call(
                    'youtube-dl -f 251 -o "media/Audio downloads/{id_generated}.%(ext)s" -q --no-playlist --extract-audio --audio-format mp3 --audio-quality 0 --no-warnings "{url}"'.format(
                ...
                subprocess.call(
                    'youtube-dl -i -o "media/{id_generated}/%(title)s.%(ext)s" --yes-playlist --extract-audio --audio-format mp3 --audio-quality 0 --no-warnings "{url}"'.format(
                        id_generated=id_generated, url=url
                    ),
                    shell=True,
                )
                ...
                subprocess.call(
                    'youtube-dl -i -o "media/{id_generated}/%(title)s.%(ext)s" --yes-playlist --newline --no-warnings "{url}"'.format(
                        id_generated=id_generated, url=url
                    ),
                    shell=True,
                )
